...
"""
"""
<plugin key="SDM230" name="Eastron SDM230-Modbus-min-" version="1.0.1" author="MFxMF">
    <params>
...
#                Total_Sstem_Apparent_Power = self.rs485.read_float(56, functioncode=4,numberOfRegisters=2)
...
#                Devices[88].Update(0,str(Total_System_Active_Power)+";"+str(Total_System_Active_Power))
  ...
  3              Domoticz.Log('Total system phase angle: {0:.3f} Degree'.format(Total_System_Phase_Angle))
